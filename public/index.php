...
<section class="toolbar"><input id="localFilter" type="search" placeholder="Keresés a mentett filmek között…"><label class="sort-control">Rendezés<select id="sortMovies"><option value="added_desc">Legutóbb hozzáadva</option><option value="title_asc">Cím A–Z</option><option value="year_desc">Megjelenés szerint</option><option value="rating_desc">Legjobb közös átlag</option></select></label><span id="movieCount"></span></section>
